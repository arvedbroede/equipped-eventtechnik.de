<section class="anfrage" id="anfrage" aria-labelledby="anfrage-heading">
      <div class="container">
        <h3 id="anfrage-heading">Jetzt reservieren</h3>
        <p class="anfrage-sub">Unverbindlich, schnell und einfach – wir melden uns schnellstmöglich bei dir.</p>

        <div id="anfrage-danke" style="display: none;">
          <p><strong>Vielen Dank!</strong> Wir haben deine Anfrage erhalten und melden uns schnellstmöglichst bei dir.</p>
        </div>
