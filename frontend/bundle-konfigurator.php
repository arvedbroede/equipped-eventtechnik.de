...
<head>
  ...
  <!-- Favicon (falls dein img/ im root liegt, musst du ggf. ../ nehmen) -->
  <link rel="icon" href="../img/logos/EQ! Icon (neu) - trans color.svg" type="image/svg" />

  <!-- Styles aus demselben Ordner 'frontend' -->
  <link rel="stylesheet" href="css/style.css" />
  <link rel="stylesheet" href="css/bundle-konfigurator.css" />

  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />

  <!-- Scripts aus demselben Ordner 'frontend' -->
  <script src="js/bundle-konfigurator.js" defer></script>
...
<body>
  ...
  <fieldset>
    ...
    <label>
    Sony GTK-XB72
      <input type="number" name="menge[Sony GTK-XB72]" min="0" max="2" value="0" data-name="Sony GTK-XB72" data-preis="15">
    </label>
    <label>
    Hughes & Kettner C152 Lautsprecher
      <input type="number" name="menge[Hughes & Kettner C152 Lautsprecher]" min="0" max="2" value="0" data-name="Hughes & Kettner C152 Lautsprecher" data-preis="15">
    </label>
    <label>
    Magnum Standard Subwoofer
      <input type="number" name="menge[Magnum Standard Subwoofer]" min="0" max="2" value="0" data-name="Magnum Standard Subwoofer" data-preis="20">
    </label>
    <label>
    Mixars Primo DJ-Controller
      <input type="number" name="menge[Mixars Primo]" min="0" max="1" value="0" data-name="Mixars Primo DJ-Controller" data-preis="20">
    </label>
    <label>
    the t.mix xmix 1202 FXMP USB
      <input type="number" name="menge[the t.mix xmix 1202 FXMP USB]" min="0" max="1" value="0" data-name="the t.mix xmix 1202 FXMP USB" data-preis="10">
    </label>
    <label>
    Aokeo Mikrofon
      <input type="number" name="menge[Aokeo Mikrofon]" min="0" max="3" value="0" data-name="Aokeo Mikrofon" data-preis="5">
    </label>
  </fieldset>
  ...
  <fieldset>
    ...
    Stairville CLB4 RGB Compact LED Bar 4
      <input type="number" name="menge[Stairville CLB4 RGB Compact LED Bar 4]" min="0" max="1" value="0" data-name="Stairville CLB4 RGB Compact LED Bar 4" data-preis="25">
    </label>
  </fieldset>
  ...
  <fieldset>
    ...
    <label>
    Superlux MS-108E Mikrofonstativ
      <input type="number" name="menge[Superlux MS-108E Mikrofonstativ]" min="0" max="2" value="0" data-name="Superlux MS-108E Mikrofonstativ" data-preis="3">
    </label>
    <label>
    Accu Stand Pro Event Table 2
    <input type="number" name="menge[Accu Stand Pro Event Table 2]" min="0" max="1" value="0" data-name="Accu Stand Pro Event Table 2" data-preis="10">
    </label>
    <label>
    Millenium Laptopstand White
    <input type="number" name="menge[Millenium Laptopstand White]" min="0" max="1" value="0" data-name="Millenium Laptopstand White" data-preis="2">
    </label>
  </fieldset>
