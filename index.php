...
<head>
  ...
  <title>Equipped! Eventtechnik GbR – Miete Sound & Licht.</title>
  ...
  <meta property="og:url" content="https://equipped-eventtechnik.de/">
...
<main role="main">
<section class="hero" aria-label="Willkommensbereich für Equipped! Eventtechnik">
  <img src="frontend/img/background/dj-background.svg" alt="Hintergrundbild mit DJ und Lichttechnik" class="hero-image" title="DJ">
  <div class="container">
    <h1>Herzlich Willkommen</h1>
    <h2>Deine Party, unsere Technik.</h2>
    <p>Miete Sound und Licht.</p>
    <a href="#bundles-preview" class="btn">Bundles entdecken</a>
  </div>
</section>
<section class="bundles-preview" id="bundles-preview" aria-labelledby="bundles-heading">
  <div class="container">
    ...
    <div class="bundle-cards">
      <div class="card">
        ...
        <h4>Stereo Bundle</h4>
        <p>Massiver Sound.</p>
        <button class="dropdown-toggle" aria-expanded="false" aria-controls="stereo-bundle-details-index">Details anzeigen <i class="fas fa-chevron-down"></i></button>
        <div class="dropdown-content" id="stereo-bundle-details-index">
      ...
      <div class="card">
        ...
        <button class="dropdown-toggle" aria-expanded="false" aria-controls="party-bundle-details-index">Details anzeigen <i class="fas fa-chevron-down"></i></button>
        <div class="dropdown-content" id="party-bundle-details-index">
          <ul class="bundle-list">
            <li>2x Sony GTK-XB72</li>
            <li>EXTRA BASS™</li>
            <li>Bluetooth, Line In</li>
      ...
      <div class="card">
        ...
        <button class="dropdown-toggle" aria-expanded="false" aria-controls="dj-bundle-details-index">Details anzeigen <i class="fas fa-chevron-down"></i></button>
        <div class="dropdown-content" id="dj-bundle-details-index">
          <ul class="bundle-list">
  ...
  <div class="container">
    <a href="bundles.php" class="btn">Alle Bundles ansehen</a>
  </div>
</section>
